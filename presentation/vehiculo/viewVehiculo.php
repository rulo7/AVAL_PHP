...
switch ($operation) {
    case Operations::CREATE:
        ...
        echo "<p>Modelo: <input type='text'  name='modelo' id='id_modelo' placeholder='Fiat 500, Seat Leon...' required></p>";
    ...
    case Operations::DELETE:
        ...
        echo "<a href='operationsVehiculo.php'><button type='button' >NO</button></a></p>";
